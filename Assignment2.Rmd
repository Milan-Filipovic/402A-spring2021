...
*1.* Feel free to ask investigators about variables you're not sure of - example, one minute APGAR score
Draw a timeline - which one are repeated measurements, longitudinal fashion, etc
Shoudl everything be complete in the dataset?
Pathological indices only for patients that died.
...
```{r}
BPD_tble %>% 
  slice(c(36, 110, 48, 253, 173, 260, 212, 168, 20, 209, 20, 5, 1, 20))

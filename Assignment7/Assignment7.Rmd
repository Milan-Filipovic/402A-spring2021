...
For the stepwise selection of the logistic regression model containing main + interaction effects for all log-transformed cytokines (except CYTO17) for only PO visits, we see significant coefficients for the intercept and the interaction CYTO3:CYTO15 at the $\alpha = 0.1$ level. 

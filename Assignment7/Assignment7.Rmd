...
A significant interaction is not observed in any of the models between ISI and visittype. IRI is significant in the CYTO23 and CYTO22 anova. 



Tryingto run logistic model with patient ID as a random effect. 
```{r}
library(lme4)
library(MASS)
...
random <- glmer(eqn, data = liri_tble, family = binomial, nAGQ = 30, control=glmerControl(optimizer="bobyqa"))

...
We attempt an ordinal logistic regression model on the numerical necrosis scores. The confidence intervals for cytokines 17 and 18 do not include 0, which suggests that they may be statistically significant.
...
We also attempt a binary response model on the positive/negative necrosis scores. All of the confidence intervals include 0, so none of the cytokines appear to be statistically significant.
...
We also try a stepwise regression model. Cytokine 2 has a p-value less than 0.05, which suggests that this cytokine specifically correlates with the dead cells in the liver after transplant.
